...
import 'package:wyz/assesments/6.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          AppText(text: "9 of 12", color: AppColors.primaryColor,
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(
              height: height * 0.25, // Responsive height for the image
              child: Image.asset("assets/gym1.png", fit: BoxFit.contain),
            ),

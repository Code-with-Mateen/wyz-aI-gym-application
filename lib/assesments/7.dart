...
import 'package:wyz/assesments/8.dart';
...
class _sevenState extends State<seven> {
  ...
  final List<String> options = ["Plant Based", "Carbo Diet", "Specialized",  "Traditional"]; // 3 options
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          AppText(text: "11 of 12", color: AppColors.primaryColor,
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Center(
              child: AppText(
                text: "Do you have a specific diet preference?",
                fontSize: 22,
                fontWeight: FontWeight.w600,
                color: Colors.black,
